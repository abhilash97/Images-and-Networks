...
def build_model():
    model = Sequential()
    model.add(Conv2D(8, (5, 5),strides = (2,2), padding='same',data_format="channels_last", input_shape=(28,28,1), activation='relu'))
...
model.fit(np.array(a_train), labels_train, epochs=20, batch_size=32)
print('Done training')
