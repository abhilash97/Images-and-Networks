#OCR using MNIST
#a logisitic regression model - simple network
#import os
import gzip
...
def build_model():
    ...
    model.add(Dense(10))#adding this loss reduces from 12->4
...
#last run - accuracy - 83.7%, loss - 2.60 without dense
#with dense - accuracy - 91.5, loss - 1.33